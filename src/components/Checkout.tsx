...
const Checkout: React.FC<CheckoutProps> = ({ cartItems, totalPrice, onBack }) => {
  ...
  const handlePlaceOrder = () => {
    ...
    const orderDetails = `
🛒 Centro Fresh and Hot Grill ORDER
...
Please confirm this order to proceed. Thank you for choosing Centro Fresh and Hot Grill! 🥘
    `.trim();

    const encodedMessage = encodeURIComponent(orderDetails);
    const messengerUrl = `https://m.me/centrofreshandhotgrill?text=${encodedMessage}`;
